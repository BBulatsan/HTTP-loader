...
func (l *LoadController) LoadTCPWithProxy(proxyTarget, target string) error {
...
func (l *LoadController) LoadTCP(target string) error {
	client, err := tcpclient.NewTCPClient(target)
	if err != nil {
		return err
	}
	n, err := client.Write([]byte{})
...
func (l *LoadController) LoadHTTPWithProxy(proxyTarget, target string) error {
...
func (l *LoadController) LoadHTTP(target string) error {
